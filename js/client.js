...
(function($) {
	...
	var Topbar = this.Topbar = Backbone.View.extend({
		...
		initialize: function() {
			this.$el.html('<img class="logo" src="http://i.imgur.com/YpYNln8.png" alt="Gold" /><div class="maintabbarbottom"></div><div class="tabbar maintabbar"><div class="inner"></div></div><div class="userbar"></div>');
	...
	var FormattingPopup = this.FormattingPopup = Popup.extend({
		...
		initialize: function() {
			var cur = this.chatformatting = Tools.prefs('chatformatting') || {hidegreentext:true};
			...
			buf += '<p><label class="optlabel"><input type="checkbox" name="greentext" ' + (cur.hidegreentext ? 'checked' : '') + ' /> Suppress <font color=#789922>&gt;greentext</font></label></p>';			
